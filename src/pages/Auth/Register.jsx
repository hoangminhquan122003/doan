...
const Register = () => {
  ...
  const [form] = Form.useForm(); // Dùng hook form để quản lý các giá trị trong form
        ...
        <div className="border px-5 py-5 rounded-xl shadow-lg">
          ...
          >
            ...
            <Form.Item
              ...
              dependencies={['password']} // Đảm bảo xác nhận mật khẩu được kiểm tra khi mật khẩu thay đổi
              rules={[
                {
                  required: true,
